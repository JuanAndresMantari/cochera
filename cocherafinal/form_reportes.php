        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-1 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="form_reportes.php"><i
    ...
    <div class="position-absolute top-50 start-50 translate-middle">
        <div class="container p-1">
            <div aria-live="polite" aria-atomic="true" class="d-flex justify-content-center align-items-center w-100">
                <div class="col-sm-12">
                    <label style="color:#0c8c8c;font-weight:bold"> Reporte Diario </label>
      ...
      <a href="imp_rdiario.php" target="_blank" aria-disabled> <input name="reg_veh" id="clt" type="submit" value="Reporte Diario"></a>
        <div class="container p-1">
            <div aria-live="polite" aria-atomic="true" class="d-flex justify-content-center align-items-center w-100">
                <div class="col-sm-12">
                <label style="color:#0c8c8c;font-weight:bold">Reporte por Rango de Fechas</label>
      ...
      <a href="form_rpt_fechas.php" aria-disabled> <input name="reg_veh" id="clt" type="submit" value="Generar Reporte"></a>
    </div>
